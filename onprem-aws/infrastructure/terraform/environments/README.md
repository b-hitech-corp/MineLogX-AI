...
|------------------|----------------------------------------------------------------|---------------------------------------------|
| `_imported-demo/` | Adopts the hand-deployed demo via import blocks. Source of truth.| `infrastructure/_imported-demo/terraform.tfstate` |
...
Fixed environments and the demo import are also driven through Fabric so the
